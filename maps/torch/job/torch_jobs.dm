/datum/map/torch
	...
	allowed_jobs = list(/datum/job/captain, /datum/job/hop, /datum/job/rd, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos,
						/datum/job/solrep, /datum/job/solguard, /datum/job/liaison, /datum/job/bodyguard, /datum/job/sea, /datum/job/psiadvisor,
						/datum/job/bridgeofficer, /datum/job/nt_pilot, /datum/job/pathfinder, /datum/job/combat_tech, /datum/job/grunt, /datum/job/combat_medic, /datum/job/field_researcher, /datum/job/explorer,
