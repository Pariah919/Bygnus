...
#define SOLGOV_BRANCHES list(/datum/mil_branch/solgov, /datum/mil_branch/fleet, /datum/mil_branch/spacefbi)

#define TACTICOOL_BRANCHES list(/datum/mil_branch/expeditionary_corps, /datum/mil_branch/fleet, /datum/mil_branch/private_security, /datum/mil_branch/spacefbi)
